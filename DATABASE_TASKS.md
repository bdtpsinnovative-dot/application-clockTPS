...
1. **บอร์ดงานสไตล์ Kanban:** แบ่งแถวแสดงสถานะทั้งสามคอลัมน์ในรูปแบบมินิบอร์ด
2. **การย้ายสถานะ:** มีฟังก์ชันลากวางการ์ดงาน (Drag & Drop) หรือปุ่มกดเพื่อเปลี่ยนค่าฟิลด์ `status` ในตาราง `tasks` โดยตรง
